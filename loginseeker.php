...
if(isset($_SESSION['seekeremail']))   // Checking whether the session is already there or not, if true then header redirect it to the homeseeker page directly
 {
    header("Location:homeseeker.php"); 
 }
if (isset($_POST['submit']))
{
	...
	$select1="select * from regseeker where email='$email' ";
...
<div class="row">
<div class="col-xl-12">
<h2>Hi JOB Seeker , Please LogIn to ndJOBS</h2><br><br>
</div>
</div>
</div>
</div>
