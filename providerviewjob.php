...
<div class="row">
	...
	<p1><?php echo $rowdata['description']?></p1><?php
	}
}
...
<br>
<br>
<input type="button" value="Unpublish" onclick="window.location.href='deletejob.php?jobid=<?php echo $jobid;?>'"/>
<input type="button" value="Update" onclick="window.location.href='updatejob.php?jobid=<?php echo $jobid;?>'"/>
</div>
</div>
</div>
</div>
