...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
    ...
    <title><?php if(isset($_SESSION['seekername']))
	{
	echo "Profile Details - ".$_SESSION['seekername'];
	}
	else if(isset($seekeremail))
	{
	$select3="select * from regseeker where email='".$seekeremail."'";		
	...
	if($tbrw3>0)
	 {
	  ...
	  {
		echo "Profile Details - ".$rowdata3['firstname']." ".$rowdata3['lastname'];
	  }
	 }	 
	}	
	?></title>
...
<div class="row">
<div class="col-lg-12">
	<h2><?php if(isset($_SESSION['seekername']))
	{
	echo "Profile Details - ".$_SESSION['seekername'];
	}
	else if(isset($seekeremail))
	...
	<?php
	if(isset($_SESSION['seekername']))
	{
	$select1="select * from regseeker where email='".$_SESSION['seekeremail']."'";
	}
	else if(isset($seekeremail))
	{
	$select1="select * from regseeker where email='".$seekeremail."'";	
	}
	...
	if(isset($seekeremail))
	{
	$select2="select * from seekerdata where email='".$seekeremail."'";
	}
...
<div class="col-xl-6">
<br><p id="p2"><button type="button" onclick="window.location.href='downloadresume.php?resumefname=<?php echo $rowdata2['resumefname'];?>'">Resume</button></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata['firstname']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata['lastname']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata['email']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata['dob']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata['gender']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata['phone']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata['curaddress']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata2['qualification']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata2['course']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata2['college']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata2['yop']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata2['designation']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata2['company']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata2['yoe']?></p>
</div>
</div>
...
<div class="col-lg-6">
<p id="p2"><?php echo $rowdata2['ctc']?></p>
</div>
</div>
<br>		
</div>
...
<div class="col-lg-1">
<input type="<?php if(isset($_SESSION['seekeremail'])) {echo 'button';} else {echo "hidden";}?>" data-toggle="modal" data-target="#modal1" value="Edit Profile"><br><br>	
</div><?php
?>
<div class="col-lg-5">
</div>
...
<div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <!-- <div class="modal-header">
      <h4 class="modal-title" id="exampleModalLabel">Edit Profile - <?php echo $_SESSION['seekername']?></h4>
